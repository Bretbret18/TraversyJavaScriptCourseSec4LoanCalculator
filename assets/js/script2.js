...
// parseFloat(), Math.pow(), toFixed() use of function parameters

// Loading GIF
let loadingGif = document.querySelector('.spinner-border');
// Results
...
function calculateResults(e) {
    ...
    if (isFinite(monthly)) {
        ...
        totalPayment.value = (monthly * calculatedPayments)
            .toFixed(2);
        totalInterest.value = ((monthly * calculatedPayments)
            - principal).toFixed(2);
